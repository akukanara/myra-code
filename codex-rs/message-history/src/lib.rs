...
//!
//! The history is stored at `~/.myra/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.myra`.
...
pub async fn append_entry(
    ...
    // Resolve `~/.myra/history.jsonl` and ensure the parent directory exists.
