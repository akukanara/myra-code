...
const SYSTEM_SKILLS_MARKER_FILENAME: &str = ".myra-system-skills.marker";
const SYSTEM_SKILLS_MARKER_SALT: &str = "v1";

/// Returns the on-disk cache location for embedded system skills from an absolute MYRA_HOME.
...
/// Installs embedded system skills into `MYRA_HOME/skills/.system`.
///
