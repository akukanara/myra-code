...
#[derive(Debug, Parser)]
#[command(bin_name = "myra plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "myra plugin marketplace add",
    after_help = "Examples:\n  myra plugin marketplace add ./path/to/marketplace\n  myra plugin marketplace add owner/repo --ref main\n  myra plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "myra plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "myra plugin marketplace upgrade",
    after_help = "Examples:\n  myra plugin marketplace upgrade\n  myra plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "myra plugin marketplace remove",
    after_help = "Example:\n  myra plugin marketplace remove debug"
)]
