...
#[derive(Debug, Parser)]
#[command(
    bin_name = "myra plugin add",
    after_help = "Examples:\n  myra plugin add sample@debug\n  myra plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "myra plugin list",
    after_help = "Examples:\n  myra plugin list\n  myra plugin list --marketplace debug\n  myra plugin list --json\n  myra plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "myra plugin remove",
    after_help = "Examples:\n  myra plugin remove sample@debug\n  myra plugin remove sample --marketplace debug"
)]
